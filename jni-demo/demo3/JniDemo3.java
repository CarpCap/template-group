...
public class JniDemo3 {
    ...
    static {
        ...
        if (osName.startsWith("win") || osName.startsWith("Win")) {
            System.load("D:\\projects\\github\\Template-group\\jni-demo\\demo3\\JniDemo3.dll");
//            System.loadLibrary("src/main/java/com/carpcap/jni/JniDemo");
        } else {
